 ...
 */
class WebOrderSystem implements WebOrderInterface, Processor {
    ...
    public WebOrderSystem() throws JMSException {
        ...
        ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory(Starter.TCP_LOCALHOST_61616);
        ...
        Destination destination = session.createQueue(Starter.WEB_NEW_ORDER);
...
class Starter {
    ...
    static final String TCP_LOCALHOST_61616 = "tcp://localhost:61616";
    static final String WEB_NEW_ORDER = "activemq:queue:WEB_NEW_ORDER";
    static final String NEW_ORDER = "activemq:queue:NEW_ORDER";
